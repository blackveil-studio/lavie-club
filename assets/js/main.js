(function(){
  ...
  var translations = {
    en: {
      ...
      "gallery.cap1": "Sunrise stretch, skyline view",
      "gallery.cap2": "Golden hour, Mykonos",
      "gallery.alt2": "Golden hour on a La Vie Club trip to Mykonos",
      "gallery.cap3": "Where we stayed, Mykonos",
      "gallery.cap4": "Wheels up",
      ...
      "gallery.cap11": "Open water, Mykonos",
      ...
      "community.quote1": "Stretching with an unreal view. The kind of workout that's +1,000,000 to your mood.",
      "community.name1": "Kate Matskevych",
      "community.quote2": "Grateful to our friends at La Vie Club for creating a space where women can restore their strength and find inspiration.",
      "community.name2": "GEPUR",
      "community.quote3": "Twice a week, in a beautiful place — the girls train together. Thanks for the incredible atmosphere.",
      "community.name3": "@kyrychenko_design",
    ...
    ua: {
      ...
      "gallery.cap1": "Ранковий стретчинг, панорама міста",
      "gallery.cap2": "Золота година, Міконос",
      "gallery.alt2": "Золота година в поїздці La Vie Club на Міконос",
      "gallery.cap3": "Де ми зупинялись, Міконос",
      "gallery.cap4": "Курс — угору",
      ...
      "community.quote1": "Стретчинг з неймовірним краєвидом. Дуже кайфове тренування — і небо таке гарне, що +1000000 до настрою.",
      "community.name1": "Kate Matskevych",
      "community.quote2": "Вдячні нашим друзям La Vie Club за те, що створюють простір, де жінки можуть відновлювати сили та надихатися.",
      "community.name2": "GEPUR",
      "community.quote3": "Два рази на тиждень, у гарному місці дівчата проводять тренування. Дякую за круту атмосферу.",
      "community.name3": "@kyrychenko_design",
